...
def test_calculate_difference_between_div_class_branch_a():
    with open("tests/html_examples/complex_example_a.html") as example_a:
        with open("tests/html_examples/complex_example_b.html") as example_b:
            a_tree = create_html_tree(example_a, specific_tag="div", class_="branch-a",)
            b_tree = create_html_tree(example_b, specific_tag="div", class_="branch-a",)
...
def test_calculate_difference_between_div_class_branch_b():
    with open("tests/html_examples/complex_example_a.html") as example_a:
        with open("tests/html_examples/complex_example_b.html") as example_b:
            a_tree = create_html_tree(example_a, specific_tag="div", class_="branch-b",)
            b_tree = create_html_tree(example_b, specific_tag="div", class_="branch-b",)
